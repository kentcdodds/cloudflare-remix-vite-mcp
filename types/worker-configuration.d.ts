/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts` (hash: f73b67b6e3810f77ce4ae11c19c614fa)
// Runtime types generated with workerd@1.20251008.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker/index");
		durableNamespaces: "MathMCP";
	}
	interface Env {
		MATH_MCP_OBJECT: DurableObjectNamespace<import("../worker/index").MathMCP>;
		ASSETS: Fetcher;
	}
}
